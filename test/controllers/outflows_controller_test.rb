...
class OutflowsControllerTest < ActionController::TestCase
  ...
  test "should create outflow" do
    assert_difference('Outflow.count') do
      post :create, outflow: { amount: @outflow.amount, category_id: @outflow.category_id, date: @outflow.date, description: @outflow.description }
    end
  ...
  test "should update outflow" do
    patch :update, id: @outflow, outflow: { amount: @outflow.amount, category_id: @outflow.category_id, date: @outflow.date, description: @outflow.description }
    assert_redirected_to outflow_path(assigns(:outflow))
  end
